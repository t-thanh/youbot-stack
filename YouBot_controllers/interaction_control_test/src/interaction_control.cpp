...
namespace ModelControl
{
	...
	interaction_control::interaction_control(string name): TaskContext(name, PreOperational),TSim_config_xml("config/interaction_control_base_config.xml")
	{
		...
		std::string path = ros::package::getPath("interaction_control_test");
	...
	XXMatrixEye (&M[266]);
	XXMatrixHomogeneous (&M[46], &M[266], &M[5]);
	...
	M[269].mat[0] = M[3].mat[0];
	M[269].mat[1] = M[3].mat[6];
	M[269].mat[2] = M[3].mat[12];
	XXMatrixSkew (&M[268], &M[269]);
	XXMatrixMul (&M[267], &M[268], &M[9]);
	M[17].mat[3] = M[267].mat[0];
	M[17].mat[4] = M[267].mat[1];
	M[17].mat[5] = M[267].mat[2];
	...
	M[272].mat[0] = M[3].mat[1];
	M[272].mat[1] = M[3].mat[7];
	M[272].mat[2] = M[3].mat[13];
	XXMatrixSkew (&M[271], &M[272]);
	XXMatrixMul (&M[270], &M[271], &M[10]);
	M[18].mat[3] = M[270].mat[0];
	M[18].mat[4] = M[270].mat[1];
	M[18].mat[5] = M[270].mat[2];
	...
	M[275].mat[0] = M[3].mat[2];
	M[275].mat[1] = M[3].mat[8];
	M[275].mat[2] = M[3].mat[14];
	XXMatrixSkew (&M[274], &M[275]);
	XXMatrixMul (&M[273], &M[274], &M[11]);
	M[19].mat[3] = M[273].mat[0];
	M[19].mat[4] = M[273].mat[1];
	M[19].mat[5] = M[273].mat[2];
	...
	M[278].mat[0] = M[3].mat[3];
	M[278].mat[1] = M[3].mat[9];
	M[278].mat[2] = M[3].mat[15];
	XXMatrixSkew (&M[277], &M[278]);
	XXMatrixMul (&M[276], &M[277], &M[12]);
	M[20].mat[3] = M[276].mat[0];
	M[20].mat[4] = M[276].mat[1];
	M[20].mat[5] = M[276].mat[2];
	...
	M[281].mat[0] = M[3].mat[4];
	M[281].mat[1] = M[3].mat[10];
	M[281].mat[2] = M[3].mat[16];
	XXMatrixSkew (&M[280], &M[281]);
	XXMatrixMul (&M[279], &M[280], &M[13]);
	M[21].mat[3] = M[279].mat[0];
	M[21].mat[4] = M[279].mat[1];
	M[21].mat[5] = M[279].mat[2];
	...
	XXMatrixEye (&M[282]);
	XXMatrixHomogeneous (&M[80], &M[282], &M[81]);
	...
	XXMatrixEye (&M[283]);
	XXMatrixHomogeneous (&M[140], &M[283], &M[141]);
	...
	XXMatrixEye (&M[284]);
	XXMatrixHomogeneous (&M[159], &M[284], &M[160]);
	...
	XXMatrixEye (&M[285]);
	XXMatrixHomogeneous (&M[178], &M[285], &M[179]);
	...
	XXMatrixEye (&M[286]);
	XXMatrixHomogeneous (&M[197], &M[286], &M[198]);
	...
	XXMatrixEye (&M[287]);
	XXMatrixHomogeneous (&M[216], &M[287], &M[217]);
	...
	M[293].mat[0] = M[243].mat[0];
	M[293].mat[1] = M[243].mat[1];
	M[293].mat[2] = M[243].mat[2];
	XXMatrixSub (&M[292], &M[264], &M[293]);
	M[244].mat[0] = M[292].mat[0];
	M[244].mat[1] = M[292].mat[1];
	M[244].mat[2] = M[292].mat[2];

	/* DemuxHW1\base.f = bond_to_base.v; */
	XXMatrixMov (&M[57], &M[252]);

	/* DemuxHW1\arm.f = bond_to_arm.omega; */
	XXMatrixMov (&M[60], &M[254]);

	/* filter\u = xyzypr; */
	XXMatrixMov (&M[61], &M[255]);

	/* MuxToControl1\base = odometry_base; */
	XXMatrixMov (&M[247], &M[256]);

	/* MuxToControl1\arm = measured_angles_arm; */
	XXMatrixMov (&M[246], &M[257]);
	...
	XXMatrixSub (&M[295], &M[61], &M[261]);
	XXScalarMatrixMul (&M[294], (V[493] * V[493]), &M[295]);
	XXScalarMatrixMul (&M[296], 1.4142 * V[493], &M[260]);
	XXMatrixSub (&M[258], &M[294], &M[296]);

	/* Gain\Rz = [cos (filter\y[4]), -sin (filter\y[4]), 0; sin (filter\y[4]), cos (filter\y[4]), 0; 0, 0, 1]; */
	M[63].mat[0] = cos (M[261].mat[3]);
	M[63].mat[1] = -(sin (M[261].mat[3]));
	M[63].mat[2] = 0.0;
	M[63].mat[3] = sin (M[261].mat[3]);
	M[63].mat[4] = cos (M[261].mat[3]);
	M[63].mat[5] = 0.0;
	M[63].mat[6] = 0.0;
	M[63].mat[7] = 0.0;
	M[63].mat[8] = 1.0;
	...
	M[64].mat[0] = cos (M[261].mat[4]);
	M[64].mat[1] = 0.0;
	M[64].mat[2] = sin (M[261].mat[4]);
	M[64].mat[3] = 0.0;
	M[64].mat[4] = 1.0;
	M[64].mat[5] = 0.0;
	M[64].mat[6] = -(sin (M[261].mat[4]));
	M[64].mat[7] = 0.0;
	M[64].mat[8] = cos (M[261].mat[4]);
	...
	M[65].mat[2] = 0.0;
	M[65].mat[3] = 0.0;
	M[65].mat[4] = cos (M[261].mat[5]);
	M[65].mat[5] = -(sin (M[261].mat[5]));
	M[65].mat[6] = 0.0;
	M[65].mat[7] = sin (M[261].mat[5]);
	M[65].mat[8] = cos (M[261].mat[5]);

	/* Gain\H = homogeneous ((Gain\Rz * Gain\Ry) * Gain\Rx, filter\y[1:3]); */
	XXMatrixMul (&M[298], &M[63], &M[64]);
	XXMatrixMul (&M[297], &M[298], &M[65]);
	M[299].mat[0] = M[261].mat[0];
	M[299].mat[1] = M[261].mat[1];
	M[299].mat[2] = M[261].mat[2];
	XXMatrixHomogeneous (&M[62], &M[297], &M[299]);

	/* MuxToControl1\control[4:8] = MuxToControl1\arm - (MuxToControl1\zero_angles * pi) / 180; */
	XXMatrixScalarMul (&M[302], &M[248], C[24]);
	XXMatrixScalarDiv (&M[301], &M[302], 180.0);
	XXMatrixSub (&M[300], &M[246], &M[301]);
	M[245].mat[3] = M[300].mat[0];
	M[245].mat[4] = M[300].mat[1];
	M[245].mat[5] = M[300].mat[2];
	M[245].mat[6] = M[300].mat[3];
	M[245].mat[7] = M[300].mat[4];

	/* MuxToControl1\control[1:3] = MuxToControl1\base; */
	M[245].mat[0] = M[247].mat[0];
	M[245].mat[1] = M[247].mat[1];
	M[245].mat[2] = M[247].mat[2];
	...
	M[48].mat[0] = cos (M[245].mat[0]);
	M[48].mat[1] = -(sin (M[245].mat[0]));
	M[48].mat[2] = 0.0;
	M[48].mat[3] = sin (M[245].mat[0]);
	M[48].mat[4] = cos (M[245].mat[0]);
	M[48].mat[5] = 0.0;
	M[48].mat[6] = 0.0;
	M[48].mat[7] = 0.0;
	M[48].mat[8] = 1.0;
	...
	M[304].mat[0] = M[245].mat[1];
	M[304].mat[1] = M[245].mat[2];
	M[304].mat[2] = 0.0;
	XXMatrixHomogeneous (&M[303], &M[48], &M[304]);
	XXMatrixMul (&M[34], &M[303], &M[46]);
	...
	M[22].mat[0] = cos (-M[245].mat[3]);
	M[22].mat[1] = -(sin (-M[245].mat[3]));
	M[22].mat[2] = 0.0;
	M[22].mat[3] = sin (-M[245].mat[3]);
	M[22].mat[4] = cos (-M[245].mat[3]);
	M[22].mat[5] = 0.0;
	M[22].mat[6] = 0.0;
	M[22].mat[7] = 0.0;
	M[22].mat[8] = 1.0;
	...
	M[23].mat[0] = cos (M[245].mat[4]);
	M[23].mat[1] = 0.0;
	M[23].mat[2] = sin (M[245].mat[4]);
	M[23].mat[3] = 0.0;
	M[23].mat[4] = 1.0;
	M[23].mat[5] = 0.0;
	M[23].mat[6] = -(sin (M[245].mat[4]));
	M[23].mat[7] = 0.0;
	M[23].mat[8] = cos (M[245].mat[4]);
	...
	M[24].mat[0] = cos (M[245].mat[5]);
	M[24].mat[1] = 0.0;
	M[24].mat[2] = sin (M[245].mat[5]);
	M[24].mat[3] = 0.0;
	M[24].mat[4] = 1.0;
	M[24].mat[5] = 0.0;
	M[24].mat[6] = -(sin (M[245].mat[5]));
	M[24].mat[7] = 0.0;
	M[24].mat[8] = cos (M[245].mat[5]);
	...
	M[25].mat[0] = cos (M[245].mat[6]);
	M[25].mat[1] = 0.0;
	M[25].mat[2] = sin (M[245].mat[6]);
	M[25].mat[3] = 0.0;
	M[25].mat[4] = 1.0;
	M[25].mat[5] = 0.0;
	M[25].mat[6] = -(sin (M[245].mat[6]));
	M[25].mat[7] = 0.0;
	M[25].mat[8] = cos (M[245].mat[6]);
	...
	M[26].mat[0] = cos (-M[245].mat[7]);
	M[26].mat[1] = -(sin (-M[245].mat[7]));
	M[26].mat[2] = 0.0;
	M[26].mat[3] = sin (-M[245].mat[7]);
	M[26].mat[4] = cos (-M[245].mat[7]);
	M[26].mat[5] = 0.0;
	M[26].mat[6] = 0.0;
	M[26].mat[7] = 0.0;
	M[26].mat[8] = 1.0;
	...
	XXMatrixMul (&M[305], &M[306], &M[14]);
	M[0].mat[0] = M[305].mat[0];
	M[0].mat[8] = M[305].mat[1];
	M[0].mat[16] = M[305].mat[2];
	M[0].mat[24] = M[305].mat[3];
	M[0].mat[32] = M[305].mat[4];
	M[0].mat[40] = M[305].mat[5];

	/* CalculateJ\controllableJ[1:6,2] = Adjoint (CalculateJ\Href0) * CalculateJ\uTryrefref; */
	XXMatrixAdjoint (&M[308], &M[34]);
	XXMatrixMul (&M[307], &M[308], &M[15]);
	M[0].mat[1] = M[307].mat[0];
	M[0].mat[9] = M[307].mat[1];
	M[0].mat[17] = M[307].mat[2];
	M[0].mat[25] = M[307].mat[3];
	M[0].mat[33] = M[307].mat[4];
	M[0].mat[41] = M[307].mat[5];

	/* CalculateJ\controllableJ[1:6,3] = Adjoint (CalculateJ\Href0) * CalculateJ\uTrxrefref; */
	XXMatrixAdjoint (&M[310], &M[34]);
	XXMatrixMul (&M[309], &M[310], &M[16]);
	M[0].mat[2] = M[309].mat[0];
	M[0].mat[10] = M[309].mat[1];
	M[0].mat[18] = M[309].mat[2];
	M[0].mat[26] = M[309].mat[3];
	M[0].mat[34] = M[309].mat[4];
	M[0].mat[42] = M[309].mat[5];

	/* CalculateJ\controllableJ[1:6,4] = Adjoint (CalculateJ\Href0) * CalculateJ\uTr1refref; */
	XXMatrixAdjoint (&M[312], &M[34]);
	XXMatrixMul (&M[311], &M[312], &M[17]);
	M[0].mat[3] = M[311].mat[0];
	M[0].mat[11] = M[311].mat[1];
	M[0].mat[19] = M[311].mat[2];
	M[0].mat[27] = M[311].mat[3];
	M[0].mat[35] = M[311].mat[4];
	M[0].mat[43] = M[311].mat[5];

	/* CalculateJ\controllableJ[1:6,5] = Adjoint (CalculateJ\H10) * CalculateJ\uTr211; */
	XXMatrixAdjoint (&M[314], &M[41]);
	XXMatrixMul (&M[313], &M[314], &M[18]);
	M[0].mat[4] = M[313].mat[0];
	M[0].mat[12] = M[313].mat[1];
	M[0].mat[20] = M[313].mat[2];
	M[0].mat[28] = M[313].mat[3];
	M[0].mat[36] = M[313].mat[4];
	M[0].mat[44] = M[313].mat[5];

	/* CalculateJ\controllableJ[1:6,6] = Adjoint (CalculateJ\H20) * CalculateJ\uTr322; */
	XXMatrixAdjoint (&M[316], &M[42]);
	XXMatrixMul (&M[315], &M[316], &M[19]);
	M[0].mat[5] = M[315].mat[0];
	M[0].mat[13] = M[315].mat[1];
	M[0].mat[21] = M[315].mat[2];
	M[0].mat[29] = M[315].mat[3];
	M[0].mat[37] = M[315].mat[4];
	M[0].mat[45] = M[315].mat[5];

	/* CalculateJ\controllableJ[1:6,7] = Adjoint (CalculateJ\H30) * CalculateJ\uTr433; */
	XXMatrixAdjoint (&M[318], &M[43]);
	XXMatrixMul (&M[317], &M[318], &M[20]);
	M[0].mat[6] = M[317].mat[0];
	M[0].mat[14] = M[317].mat[1];
	M[0].mat[22] = M[317].mat[2];
	M[0].mat[30] = M[317].mat[3];
	M[0].mat[38] = M[317].mat[4];
	M[0].mat[46] = M[317].mat[5];

	/* CalculateJ\controllableJ[1:6,8] = Adjoint (CalculateJ\H40) * CalculateJ\uTr544; */
	XXMatrixAdjoint (&M[320], &M[44]);
	XXMatrixMul (&M[319], &M[320], &M[21]);
	M[0].mat[7] = M[319].mat[0];
	M[0].mat[15] = M[319].mat[1];
	M[0].mat[23] = M[319].mat[2];
	M[0].mat[31] = M[319].mat[3];
	M[0].mat[39] = M[319].mat[4];
	M[0].mat[47] = M[319].mat[5];

		/* JointSoftLimits\tempstate = MuxToControl1\control; */
		XXMatrixMov (&M[237], &M[245]);
		...
		XXMatrixDiag (&M[322], &M[232]);
		XXMatrixMul (&M[321], &M[322], &M[233]);
		XXMatrixMul (&M[228], &M[321], &M[237]);

	/* JointSpaceStiffness\x[4:8] = MuxToControl1\control[4:8] - JointSpaceStiffness\setpoints[4:8]; */
	M[324].mat[0] = M[245].mat[3];
	M[324].mat[1] = M[245].mat[4];
	M[324].mat[2] = M[245].mat[5];
	M[324].mat[3] = M[245].mat[6];
	M[324].mat[4] = M[245].mat[7];
	M[325].mat[0] = M[243].mat[3];
	M[325].mat[1] = M[243].mat[4];
	M[325].mat[2] = M[243].mat[5];
	M[325].mat[3] = M[243].mat[6];
	M[325].mat[4] = M[243].mat[7];
	XXMatrixSub (&M[323], &M[324], &M[325]);
	M[244].mat[3] = M[323].mat[0];
	M[244].mat[4] = M[323].mat[1];
	M[244].mat[5] = M[323].mat[2];
	M[244].mat[6] = M[323].mat[3];
	M[244].mat[7] = M[323].mat[4];

	/* JointSpaceStiffness\p.e = diag (JointSpaceStiffness\c) * JointSpaceStiffness\x; */
	XXMatrixDiag (&M[326], &M[242]);
	XXMatrixMul (&M[241], &M[326], &M[244]);

	/* CartesianSpaceSitiffness\state = inverse (Gain\H) * CalculateJ\Htip0; */
	XXMatrixInverse (&M[327], &M[62], workarray);
	XXMatrixMul (&M[50], &M[327], &M[1]);

	/* CartesianSpaceSitiffness\temp = (trace (CartesianSpaceSitiffness\state[1:3,1:3]) - 1) / 2; */
	M[329].mat[0] = M[50].mat[0];
	M[329].mat[1] = M[50].mat[1];
	M[329].mat[2] = M[50].mat[2];
	M[329].mat[3] = M[50].mat[4];
	M[329].mat[4] = M[50].mat[5];
	M[329].mat[5] = M[50].mat[6];
	M[329].mat[6] = M[50].mat[8];
	M[329].mat[7] = M[50].mat[9];
	M[329].mat[8] = M[50].mat[10];
	M[328].mat[0] = XXMatrixTrace (&M[329]);
	V[447] = (XXMatrixTrace (&M[329]) - 1.0) / 2.0;
	...
	else
	{
		...
		M[332].mat[0] = M[50].mat[9] - M[50].mat[6];
		M[332].mat[1] = M[50].mat[2] - M[50].mat[8];
		M[332].mat[2] = M[50].mat[4] - M[50].mat[1];
		XXScalarMatrixMul (&M[51], (1.0 / (2.0 * sin (V[431]))), &M[332]);
	}

	/* CartesianSpaceSitiffness\Wt[4:6] = (CartesianSpaceSitiffness\state[1:3,4] * CartesianSpaceSitiffness\CtipTranslation); */
	M[334].mat[0] = M[50].mat[3];
	M[334].mat[1] = M[50].mat[7];
	M[334].mat[2] = M[50].mat[11];
	XXMatrixScalarMul (&M[333], &M[334], P[42]);
	M[53].mat[3] = M[333].mat[0];
	M[53].mat[4] = M[333].mat[1];
	M[53].mat[5] = M[333].mat[2];
	...
	M[336].mat[0] = M[50].mat[3];
	M[336].mat[1] = M[50].mat[7];
	M[336].mat[2] = M[50].mat[11];
	XXMatrixTranspose (&M[335], &M[336]);
	M[337].mat[0] = M[50].mat[3];
	M[337].mat[1] = M[50].mat[7];
	M[337].mat[2] = M[50].mat[11];
	XXScalarMatrixMatrixMul (&R[12], &M[335], &M[337]);
	...
	XXScalarMatrixMul (&M[339], V[431], &M[51]);
	XXMatrixScalarMul (&M[338], &M[339], (P[43]));
	M[52].mat[0] = M[338].mat[0];
	M[52].mat[1] = M[338].mat[1];
	M[52].mat[2] = M[338].mat[2];

	/* CartesianSpaceSitiffness\p.e = inverse (transpose (Adjoint (Gain\H))) * (CartesianSpaceSitiffness\Wt + CartesianSpaceSitiffness\Wr); */
	XXMatrixAdjoint (&M[342], &M[62]);
	XXMatrixTranspose (&M[341], &M[342]);
	XXMatrixInverse (&M[340], &M[341], workarray);
	XXMatrixAdd (&M[343], &M[53], &M[52]);
	XXMatrixMul (&M[49], &M[340], &M[343]);
		...
		XXMatrixAdjoint (&M[345], &M[68]);
		XXMatrixTranspose (&M[344], &M[345]);
		XXMatrixMul (&M[67], &M[344], &M[78]);
		...
		XXMatrixAdjoint (&M[346], &M[68]);
		XXMatrixMul (&M[66], &M[346], &M[72]);
	...
	/* JointSpaceDamping\p.e = JointSpaceDamping\R * DemuxHW1\control.f; */
	XXMatrixMul (&M[238], &M[240], &M[58]);

	/* JointSpaceStiffness\sub_state_dot = DemuxHW1\control.f[1:3]; */
	M[263].mat[0] = M[58].mat[0];
	M[263].mat[1] = M[58].mat[1];
	M[263].mat[2] = M[58].mat[2];

	/* OneJunction\p2.e = -CartesianSpaceSitiffness\p.e; */
	XXMatrixInv (&M[249], &M[49]);

	/* ControllableJ\joints.e = transpose (CalculateJ\controllableJ) * OneJunction\p2.e; */
	XXMatrixTranspose (&M[347], &M[0]);
	XXMatrixMul (&M[54], &M[347], &M[249]);
	...
	XXMatrixMul (&M[91], &M[139], &M[88]);
		...
		XXMatrixAdjoint (&M[349], &M[128]);
		XXMatrixTranspose (&M[348], &M[349]);
		XXMatrixMul (&M[127], &M[348], &M[138]);
		...
		XXMatrixAdjoint (&M[350], &M[128]);
		XXMatrixMul (&M[126], &M[350], &M[132]);
	...
	XXMatrixTranspose (&M[352], &M[137]);
	XXScalarMatrixDiv (&M[351], 1.0, &M[352], workarray);
	XXMatrixMul (&M[131], &M[351], &M[127]);
	...
	XXMatrixMul (&M[177], &M[99], &M[178]);
		...
		XXMatrixAdjoint (&M[354], &M[147]);
		XXMatrixTranspose (&M[353], &M[354]);
		XXMatrixMul (&M[146], &M[353], &M[157]);
		...
		XXMatrixAdjoint (&M[355], &M[147]);
		XXMatrixMul (&M[145], &M[355], &M[151]);
	...
	XXMatrixTranspose (&M[357], &M[156]);
	XXScalarMatrixDiv (&M[356], 1.0, &M[357], workarray);
	XXMatrixMul (&M[150], &M[356], &M[146]);
	...
	XXMatrixMul (&M[115], &M[196], &M[112]);
		...
		XXMatrixAdjoint (&M[359], &M[166]);
		XXMatrixTranspose (&M[358], &M[359]);
		XXMatrixMul (&M[165], &M[358], &M[176]);
		...
		XXMatrixAdjoint (&M[360], &M[166]);
		XXMatrixMul (&M[164], &M[360], &M[170]);
	...
	XXMatrixTranspose (&M[362], &M[175]);
	XXScalarMatrixDiv (&M[361], 1.0, &M[362], workarray);
	XXMatrixMul (&M[169], &M[361], &M[165]);
		...
		XXMatrixAdjoint (&M[364], &M[185]);
		XXMatrixTranspose (&M[363], &M[364]);
		XXMatrixMul (&M[184], &M[363], &M[195]);
		...
		XXMatrixAdjoint (&M[365], &M[185]);
		XXMatrixMul (&M[183], &M[365], &M[189]);
	...
	XXMatrixTranspose (&M[367], &M[194]);
	XXScalarMatrixDiv (&M[366], 1.0, &M[367], workarray);
	XXMatrixMul (&M[188], &M[366], &M[184]);
		...
		XXMatrixAdjoint (&M[369], &M[204]);
		XXMatrixTranspose (&M[368], &M[369]);
		XXMatrixMul (&M[203], &M[368], &M[214]);
		...
		XXMatrixAdjoint (&M[370], &M[204]);
		XXMatrixMul (&M[202], &M[370], &M[208]);
	...
	XXMatrixTranspose (&M[372], &M[213]);
	XXScalarMatrixDiv (&M[371], 1.0, &M[372], workarray);
	XXMatrixMul (&M[207], &M[371], &M[203]);
	...
	XXMatrixAdjoint (&M[377], &M[197]);
	XXMatrixTranspose (&M[376], &M[377]);
	XXMatrixMul (&M[186], &M[376], &M[110]);
	...
	XXMatrixAdjoint (&M[382], &M[178]);
	XXMatrixTranspose (&M[381], &M[382]);
	XXMatrixMul (&M[167], &M[381], &M[102]);
	...
	XXMatrixAdjoint (&M[387], &M[159]);
	XXMatrixTranspose (&M[386], &M[387]);
	XXMatrixMul (&M[148], &M[386], &M[94]);
	...
	XXMatrixAdjoint (&M[392], &M[140]);
	XXMatrixTranspose (&M[391], &M[392]);
	XXMatrixMul (&M[129], &M[391], &M[86]);
	...
	XXMatrixAdjoint (&M[395], &M[120]);
	XXMatrixTranspose (&M[394], &M[395]);
	XXScalarMatrixDiv (&M[393], 1.0, &M[394], workarray);
	XXMatrixMul (&M[118], &M[393], &M[142]);
	...
	/* OneJunction2\p4.e = ((GravityCompensation1\Mux\port.e + ControllableJ\joints.e) - JointSpaceStiffness\p.e) - (JointSpaceDamping\p.e + JointSoftLimits\p.e); */
	XXMatrixAdd (&M[397], &M[221], &M[54]);
	XXMatrixSub (&M[396], &M[397], &M[241]);
	XXMatrixAdd (&M[398], &M[238], &M[228]);
	XXMatrixSub (&M[250], &M[396], &M[398]);

	/* DemuxHW1\base.e = OneJunction2\p4.e[1:3]; */
	M[56].mat[0] = M[250].mat[0];
	M[56].mat[1] = M[250].mat[1];
	M[56].mat[2] = M[250].mat[2];

	/* DemuxHW1\arm.e = OneJunction2\p4.e[4:8]; */
	M[59].mat[0] = M[250].mat[3];
	M[59].mat[1] = M[250].mat[4];
	M[59].mat[2] = M[250].mat[5];
	M[59].mat[3] = M[250].mat[6];
	M[59].mat[4] = M[250].mat[7];

	/* bond_to_base.F = DemuxHW1\base.e; */
	XXMatrixMov (&M[251], &M[56]);

	/* bond_to_arm.T = DemuxHW1\arm.e; */
	XXMatrixMov (&M[253], &M[59]);
	...
	XXMatrixTranspose (&M[400], &M[53]);
	XXScalarMatrixMatrixMul (M[399].mat, &M[400], &M[53]);
	V[448] = sqrt (M[399].mat[0]);
	...
	XXMatrixTranspose (&M[402], &M[77]);
	XXScalarMatrixDiv (&M[401], 1.0, &M[402], workarray);
	XXMatrixMul (&M[71], &M[401], &M[67]);
	...
	XXMatrixAdjoint (&M[404], &M[120]);
	XXScalarMatrixDiv (&M[403], 1.0, &M[404], workarray);
	XXMatrixMul (&M[119], &M[403], &M[125]);
	...
	XXMatrixAdjoint (&M[405], &M[140]);
	XXMatrixMul (&M[130], &M[405], &M[119]);
	...
	XXScalarMatrixDiv (&M[406], 1.0, &M[137], workarray);
	XXMatrixMul (&M[132], &M[406], &M[119]);
	...
	XXMatrixAdjoint (&M[416], &M[104]);
	XXScalarMatrixDiv (&M[415], 1.0, &M[416], workarray);
	XXMatrixMul (&M[103], &M[415], &M[109]);
	...
	XXMatrixAdjoint (&M[417], &M[197]);
	XXMatrixMul (&M[187], &M[417], &M[103]);

	/* GravityCompensation1\Link4\AdHik1\p2.f = (1.0 / GravityCompensation1\Link4\AdHik1\AdH) * GravityCompensation1\Joint34\AdHji\p2.f; */
	XXScalarMatrixDiv (&M[418], 1.0, &M[194], workarray);
	XXMatrixMul (&M[189], &M[418], &M[103]);
	...
	XXMatrixAdjoint (&M[424], &M[80]);
	XXMatrixTranspose (&M[423], &M[424]);
	XXMatrixMul (&M[69], &M[423], &M[118]);
	...
	bool interaction_control::initializeComputation()
	{
		...
		number_constants = 25;
		number_parameters = 242;
		number_initialvalues = 16;
		number_variables = 2140;
		number_states = 16;
		number_rates = 16;
		number_matrices = 425;
		number_unnamed = 3849;
		...
		P = new XXDouble[242 + 1]; /* parameters, currently only one type of parameter exists: double */
		I = new XXDouble[16 + 1]; /* initial values */
		V = new XXDouble[2140 + 1]; /* variables */

		s = new XXDouble[16 + 1]; /* states */
		R = new XXDouble[16 + 1]; /* rates (or new states) */
		M = new XXMatrix[425 + 1]; /* matrices */
		U = new XXDouble[3849 + 1]; /* unnamed */
	...
	M[239].rows = 8;
	M[239].columns = 1;
	M[240].mat = &V[2000];		/* JointSpaceDamping\R */
	M[240].rows = 8;
	M[240].columns = 8;
	M[241].mat = &V[2064];		/* JointSpaceStiffness\p.e */
	M[241].rows = 8;
	M[241].columns = 1;
	M[242].mat = &P[221];		/* JointSpaceStiffness\c */
	M[242].rows = 8;
	M[242].columns = 1;
	M[243].mat = &P[229];		/* JointSpaceStiffness\setpoints */
	M[243].rows = 8;
	M[243].columns = 1;
	M[244].mat = &V[2072];		/* JointSpaceStiffness\x */
	M[244].rows = 8;
	M[244].columns = 1;
	M[245].mat = &V[2080];		/* MuxToControl1\control */
	M[245].rows = 8;
	M[245].columns = 1;
	M[246].mat = &V[2088];		/* MuxToControl1\arm */
	M[246].rows = 5;
	M[246].columns = 1;
	M[247].mat = &V[2093];		/* MuxToControl1\base */
	M[247].rows = 3;
	M[247].columns = 1;
	M[248].mat = &P[237];		/* MuxToControl1\zero_angles */
	M[248].rows = 5;
	M[248].columns = 1;
	M[249].mat = &V[2096];		/* OneJunction\p2.e */
	M[249].rows = 6;
	M[249].columns = 1;
	M[250].mat = &V[2102];		/* OneJunction2\p4.e */
	M[250].rows = 8;
	M[250].columns = 1;
	M[251].mat = &V[2110];		/* bond_to_base.F */
	M[251].rows = 3;
	M[251].columns = 1;
	M[252].mat = &V[2113];		/* bond_to_base.v */
	M[252].rows = 3;
	M[252].columns = 1;
	M[253].mat = &V[2116];		/* bond_to_arm.T */
	M[253].rows = 5;
	M[253].columns = 1;
	M[254].mat = &V[2121];		/* bond_to_arm.omega */
	M[254].rows = 5;
	M[254].columns = 1;
	M[255].mat = &V[2126];		/* xyzypr */
	M[255].rows = 6;
	M[255].columns = 1;
	M[256].mat = &V[2132];		/* odometry_base */
	M[256].rows = 3;
	M[256].columns = 1;
	M[257].mat = &V[2135];		/* measured_angles_arm */
	M[257].rows = 5;
	M[257].columns = 1;
	...
	M[262].rows = 6;
	M[262].columns = 1;
	M[263].mat = &R[13];		/* JointSpaceStiffness\sub_state_dot */
	M[263].rows = 3;
	M[263].columns = 1;
	M[264].mat = &s[13];		/* JointSpaceStiffness\sub_state */
	M[264].rows = 3;
	M[264].columns = 1;
	M[265].mat = &I[13];		/* JointSpaceStiffness\sub_state_initial */
	M[265].rows = 3;
	M[265].columns = 1;
	M[266].mat = &U[0];		/* U1 */
	M[266].rows = 3;
	...
	M[341].rows = 6;
	M[341].columns = 6;
	M[342].mat = &U[1028];		/* U77 */
	M[342].rows = 6;
	M[342].columns = 6;
	M[343].mat = &U[1064];		/* U78 */
	M[343].rows = 6;
	M[343].columns = 1;
	M[344].mat = &U[1070];		/* U79 */
	M[344].rows = 6;
	M[344].columns = 6;
	M[345].mat = &U[1106];		/* U80 */
	M[345].rows = 6;
	M[345].columns = 6;
	M[346].mat = &U[1142];		/* U81 */
	M[346].rows = 6;
	M[346].columns = 6;
	M[347].mat = &U[1178];		/* U82 */
	M[347].rows = 8;
	M[347].columns = 6;
	M[348].mat = &U[1226];		/* U83 */
	M[348].rows = 6;
	M[348].columns = 6;
	M[349].mat = &U[1262];		/* U84 */
	M[349].rows = 6;
	M[349].columns = 6;
	M[350].mat = &U[1298];		/* U85 */
	M[350].rows = 6;
	M[350].columns = 6;
	M[351].mat = &U[1334];		/* U86 */
	M[351].rows = 6;
	M[351].columns = 6;
	M[352].mat = &U[1370];		/* U87 */
	M[352].rows = 6;
	M[352].columns = 6;
	M[353].mat = &U[1406];		/* U88 */
	M[353].rows = 6;
	M[353].columns = 6;
	M[354].mat = &U[1442];		/* U89 */
	M[354].rows = 6;
	M[354].columns = 6;
	M[355].mat = &U[1478];		/* U90 */
	M[355].rows = 6;
	M[355].columns = 6;
	M[356].mat = &U[1514];		/* U91 */
	M[356].rows = 6;
	M[356].columns = 6;
	M[357].mat = &U[1550];		/* U92 */
	M[357].rows = 6;
	M[357].columns = 6;
	M[358].mat = &U[1586];		/* U93 */
	M[358].rows = 6;
	M[358].columns = 6;
	M[359].mat = &U[1622];		/* U94 */
	M[359].rows = 6;
	M[359].columns = 6;
	M[360].mat = &U[1658];		/* U95 */
	M[360].rows = 6;
	M[360].columns = 6;
	M[361].mat = &U[1694];		/* U96 */
	M[361].rows = 6;
	M[361].columns = 6;
	M[362].mat = &U[1730];		/* U97 */
	M[362].rows = 6;
	M[362].columns = 6;
	M[363].mat = &U[1766];		/* U98 */
	M[363].rows = 6;
	M[363].columns = 6;
	M[364].mat = &U[1802];		/* U99 */
	M[364].rows = 6;
	M[364].columns = 6;
	M[365].mat = &U[1838];		/* U100 */
	M[365].rows = 6;
	M[365].columns = 6;
	M[366].mat = &U[1874];		/* U101 */
	M[366].rows = 6;
	M[366].columns = 6;
	M[367].mat = &U[1910];		/* U102 */
	M[367].rows = 6;
	M[367].columns = 6;
	M[368].mat = &U[1946];		/* U103 */
	M[368].rows = 6;
	M[368].columns = 6;
	M[369].mat = &U[1982];		/* U104 */
	M[369].rows = 6;
	M[369].columns = 6;
	M[370].mat = &U[2018];		/* U105 */
	M[370].rows = 6;
	M[370].columns = 6;
	M[371].mat = &U[2054];		/* U106 */
	M[371].rows = 6;
	M[371].columns = 6;
	M[372].mat = &U[2090];		/* U107 */
	M[372].rows = 6;
	M[372].columns = 6;
	M[373].mat = &U[2126];		/* U108 */
	M[373].rows = 6;
	M[373].columns = 6;
	M[374].mat = &U[2162];		/* U109 */
	M[374].rows = 6;
	M[374].columns = 6;
	M[375].mat = &U[2198];		/* U110 */
	M[375].rows = 6;
	M[375].columns = 6;
	M[376].mat = &U[2234];		/* U111 */
	M[376].rows = 6;
	M[376].columns = 6;
	M[377].mat = &U[2270];		/* U112 */
	M[377].rows = 6;
	M[377].columns = 6;
	M[378].mat = &U[2306];		/* U113 */
	M[378].rows = 6;
	M[378].columns = 6;
	M[379].mat = &U[2342];		/* U114 */
	M[379].rows = 6;
	M[379].columns = 6;
	M[380].mat = &U[2378];		/* U115 */
	M[380].rows = 6;
	M[380].columns = 6;
	M[381].mat = &U[2414];		/* U116 */
	M[381].rows = 6;
	M[381].columns = 6;
	M[382].mat = &U[2450];		/* U117 */
	M[382].rows = 6;
	M[382].columns = 6;
	M[383].mat = &U[2486];		/* U118 */
	M[383].rows = 6;
	M[383].columns = 6;
	M[384].mat = &U[2522];		/* U119 */
	M[384].rows = 6;
	M[384].columns = 6;
	M[385].mat = &U[2558];		/* U120 */
	M[385].rows = 6;
	M[385].columns = 6;
	M[386].mat = &U[2594];		/* U121 */
	M[386].rows = 6;
	M[386].columns = 6;
	M[387].mat = &U[2630];		/* U122 */
	M[387].rows = 6;
	M[387].columns = 6;
	M[388].mat = &U[2666];		/* U123 */
	M[388].rows = 6;
	M[388].columns = 6;
	M[389].mat = &U[2702];		/* U124 */
	M[389].rows = 6;
	M[389].columns = 6;
	M[390].mat = &U[2738];		/* U125 */
	M[390].rows = 6;
	M[390].columns = 6;
	M[391].mat = &U[2774];		/* U126 */
	M[391].rows = 6;
	M[391].columns = 6;
	M[392].mat = &U[2810];		/* U127 */
	M[392].rows = 6;
	M[392].columns = 6;
	M[393].mat = &U[2846];		/* U128 */
	M[393].rows = 6;
	M[393].columns = 6;
	M[394].mat = &U[2882];		/* U129 */
	M[394].rows = 6;
	M[394].columns = 6;
	M[395].mat = &U[2918];		/* U130 */
	M[395].rows = 6;
	M[395].columns = 6;
	M[396].mat = &U[2954];		/* U131 */
	M[396].rows = 8;
	M[396].columns = 1;
	M[397].mat = &U[2962];		/* U132 */
	M[397].rows = 8;
	M[397].columns = 1;
	M[398].mat = &U[2970];		/* U133 */
	M[398].rows = 8;
	M[398].columns = 1;
	M[399].mat = &U[2978];		/* U134 */
	M[399].rows = 1;
	M[399].columns = 1;
	M[400].mat = &U[2979];		/* U135 */
	M[400].rows = 1;
	M[400].columns = 6;
	M[401].mat = &U[2985];		/* U136 */
	M[401].rows = 6;
	M[401].columns = 6;
	M[402].mat = &U[3021];		/* U137 */
	M[402].rows = 6;
	M[402].columns = 6;
	M[403].mat = &U[3057];		/* U138 */
	M[403].rows = 6;
	M[403].columns = 6;
	M[404].mat = &U[3093];		/* U139 */
	M[404].rows = 6;
	M[404].columns = 6;
	M[405].mat = &U[3129];		/* U140 */
	M[405].rows = 6;
	M[405].columns = 6;
	M[406].mat = &U[3165];		/* U141 */
	M[406].rows = 6;
	M[406].columns = 6;
	M[407].mat = &U[3201];		/* U142 */
	M[407].rows = 6;
	M[407].columns = 6;
	M[408].mat = &U[3237];		/* U143 */
	M[408].rows = 6;
	M[408].columns = 6;
	M[409].mat = &U[3273];		/* U144 */
	M[409].rows = 6;
	M[409].columns = 6;
	M[410].mat = &U[3309];		/* U145 */
	M[410].rows = 6;
	M[410].columns = 6;
	M[411].mat = &U[3345];		/* U146 */
	M[411].rows = 6;
	M[411].columns = 6;
	M[412].mat = &U[3381];		/* U147 */
	M[412].rows = 6;
	M[412].columns = 6;
	M[413].mat = &U[3417];		/* U148 */
	M[413].rows = 6;
	M[413].columns = 6;
	M[414].mat = &U[3453];		/* U149 */
	M[414].rows = 6;
	M[414].columns = 6;
	M[415].mat = &U[3489];		/* U150 */
	M[415].rows = 6;
	M[415].columns = 6;
	M[416].mat = &U[3525];		/* U151 */
	M[416].rows = 6;
	M[416].columns = 6;
	M[417].mat = &U[3561];		/* U152 */
	M[417].rows = 6;
	M[417].columns = 6;
	M[418].mat = &U[3597];		/* U153 */
	M[418].rows = 6;
	M[418].columns = 6;
	M[419].mat = &U[3633];		/* U154 */
	M[419].rows = 6;
	M[419].columns = 6;
	M[420].mat = &U[3669];		/* U155 */
	M[420].rows = 6;
	M[420].columns = 6;
	M[421].mat = &U[3705];		/* U156 */
	M[421].rows = 6;
	M[421].columns = 6;
	M[422].mat = &U[3741];		/* U157 */
	M[422].rows = 6;
	M[422].columns = 6;
	M[423].mat = &U[3777];		/* U158 */
	M[423].rows = 6;
	M[423].columns = 6;
	M[424].mat = &U[3813];		/* U159 */
	M[424].rows = 6;
	M[424].columns = 6;
