...
namespace ModelControl
{
	...
	XXMatrixMov (&M[252], &M[57]);

	/* bond_to_arm.T = DemuxHW1\arm.e; */
	XXMatrixMov (&M[254], &M[60]);
	...
	M[252].rows = 3;
	M[252].columns = 1;
	M[253].mat = &V[2057];		/* bond_to_base.v */
	M[253].rows = 3;
	M[253].columns = 1;
	M[254].mat = &V[2060];		/* bond_to_arm.T */
	M[254].rows = 5;
	M[254].columns = 1;
	M[255].mat = &V[2065];		/* bond_to_arm.omega */
	M[255].rows = 5;
	M[255].columns = 1;
